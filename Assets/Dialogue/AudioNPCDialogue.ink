...
==FailedMinigame==
Hey, no worries!#speaker:{NPCName}
We all make mistakes.#speaker:{NPCName}
As a tip, look closely at the label, and then at the symbol on each track.#speaker:{NPCName}
+[I'd like to try again. #startminigame]
    ~StartMinigame()
    ->DONE
+[Let me take a breather...]
No problem! Just help out when you feel like it.#speaker:{NPCName}
    ->DONE
